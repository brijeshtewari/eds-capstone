...
var CustomImportScript = (() => {
  ...
  var PAGE_TEMPLATE = {
    name: "faqs",
    description: 'WKND FAQs page: title, hero image, intro paragraph, an expandable Q&A accordion, and a "Need more help?" contact panel.',
    blocks: [
      {
        name: "accordion-faq",
    ...
    sections: [
      {
        id: "section-1-faq-main",
        name: "faq-main",
        selector: [".container.responsivegrid.aem-GridColumn--default--8", ".cmp-accordion"],
        style: null,
        blocks: ["accordion-faq"],
        defaultContent: [".title.cmp-title--underline .cmp-title__text", ".cmp-image__image", ".text .cmp-text"]
      },
      {
        id: "section-2-need-help",
        name: "need-help",
        selector: [".container.responsivegrid.aem-GridColumn--default--3", ".cmp-title--right"],
        style: null,
        blocks: [],
